...
export interface ApiRetreatRetreat extends Struct.CollectionTypeSchema {
  collectionName: 'retreats';
  info: {
    description: 'Yoga retreats and wellness events';
    displayName: 'Retreat';
    pluralName: 'retreats';
    singularName: 'retreat';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Yoga instructors and team members';
...
export interface ApiTeamPageTeamPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Manage the order of team members displayed on the team page';
